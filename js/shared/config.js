...
// Base (design) resolution — all pixel values were originally designed at this size
export const BASE_CANVAS_WIDTH  = 920;
export const BASE_CANVAS_HEIGHT = 614;
...
export const CANVAS_WIDTH  = 1195;
